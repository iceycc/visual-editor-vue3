...
export const VisualEditor = defineComponent({
    ...
    setup(props, ctx) {
        ...
        // dragStart.on(() => console.log('listen drag start'))
        // dragEnd.on(() => console.log('listen drag end'))
        ...
        const buttons = [
            ...
            {label: '清除', icon: 'icon-reset', handler: () => commander.clear()},
        ...
        return () => <div class="visual-editor">
            ...
            <div class="visual-editor-head">
                {buttons.map((btn, index) => {
                    return <el-tooltip effect="dark" content={btn.tip} placement="bottom" key={index}>
